...
export default function Hero() {
  ...
  return (
    <main className="flex h-screen flex-col justify-center">
      <section className="isolate flex h-6/7 flex-col place-content-evenly place-items-center pb-4 sm:gap-20 sm:text-lg md:gap-24 md:text-xl lg:flex-row lg:flex-wrap lg:place-content-center lg:gap-x-36 lg:ps-6 lg:pt-0 lg:text-2xl xl:gap-x-52 xl:ps-8 3xl:ps-12">
        ...
        <div className="-z-10 mt-4 flex h-1/4 w-full flex-col justify-center gap-4 bg-gray-300 py-20 text-center lg:basis-1/3 lg:space-y-24 lg:bg-inherit">
