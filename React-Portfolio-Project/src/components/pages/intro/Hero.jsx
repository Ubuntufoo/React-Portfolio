        ...
        <Parallelogram parallelogramClasses={parallelogramClasses}>
          <section className="grid grid-cols-1 grid-rows-6 h-full">
            ...
            <img
              src={Tim1_5}
              alt="Tim's image"
              className="absolute -bottom-16 -right-20 scale-[0.7] animate-fade sm:-bottom-8  md:-right-2 md:bottom-10 md:scale-100 lg:-bottom-20 lg:right-4 lg:scale-50 xl:-bottom-6 xl:right-24 xl:scale-75 2xl:bottom-6 2xl:right-64 3xl:scale-[1.35] 3xl:right-96 2xl:scale-110"
            />
