      ...
      {animationEnded ? (
        <Parallelogram parallelogramClasses={parallelogramClasses}>
          <section className="grid grid-cols-1 grid-rows-6 h-full">
            ...
            />
            <div className="row-start-2 mx-5 relative h-fit  z-10 animate-fade space-y-4 leading-snug text-black md:text-2xl lg:text-xl lg:ps-4 xl:ps-10 xl:pt-6 2xl:space-y-9 2xl:text-2xl 2xl:ps-20 2xl:pt-8">
