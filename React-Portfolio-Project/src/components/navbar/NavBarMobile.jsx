...
export default function NavBarMobile() {
  ...
  return (
    ...
    >
      ...
      <div
        className={` ${isOpen ? 'translate-y-0' : '-translate-y-full'} relative bottom-8 grid h-screen grid-cols-2 place-content-evenly place-items-center text-xl transition-all duration-300 md:mb-0 md:text-2xl lg:text-3xl`}
      >
