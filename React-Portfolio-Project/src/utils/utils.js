...
export const skillCardsContent = [
  {
    ...
    firstPara: "My focus is on modern React, context management and routing libraries.\n\nI prefer learning from the ground up. I generally avoid leaning into pre-built components until I'm 100% familiar with its inner-workings.",
