...
export const skillCardsContent = [
  {
    ...
    firstPara: "I follow a structured learning path of React concepts. My projects focus on efficiency and best practices.\n\nI prefer learning from the ground up, and generally avoid pre-built components until I can build it comfortably from scratch. This approach has helped me understand the inner workings of React and its ecosystem.",
    secondHeader: 'Learning Roadmap',
    secondPara: "I'm currently developing a robust application with Next.js and Typescript to improve my full stack competency.\n\nAs my projects scale up I plan to further embrace performance optimization and SEO considerations. To avoid becoming too specialized I make sure to revisit raw Javascript from time to time.",
  },
  {
    img: genaiIMG,
    title: 'Generative AI \nIntegration',
